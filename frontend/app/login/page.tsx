  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        ...
        >
          <motion.div
            className="flex mb-6 bg-white/20 backdrop-blur-sm rounded-xl p-1 border border-white/20"
          ...
          >
            <motion.button
              ...
              className={`flex-1 py-3 px-6 rounded-lg font-semibold transition-all duration-300 relative ${
                isLogin ? "text-[#0072ff] shadow-lg" : "text-gray-100 hover:bg-white/20 hover:text-white"
              }`}
          ...
          <div className="relative overflow-hidden">
            <AnimatePresence mode="wait" custom={isLogin ? 1 : -1}>
              {isLogin ? (
                ...
                >
                  <Card className="bg-white/95 backdrop-blur-sm border-0 shadow-2xl p-8 border border-white/20">
                    <motion.div
                    ...
                    >
                      ...
                      <p className="text-muted-foreground">Please enter your login and password</p>
                    </motion.div>
          ...
          >
            <motion.div
              className={`w-2 h-2 rounded-full transition-all duration-300 ${isLogin ? "bg-white" : "bg-white/50"}`}
              animate={{
                scale: isLogin ? 1.2 : 1,
