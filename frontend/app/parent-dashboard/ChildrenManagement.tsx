...
export default function ChildrenManagement({ parent }: ChildrenManagementProps) {
  ...
  return (
    <div className="h-full bg-white rounded-2xl shadow p-6 overflow-y-auto">
      {/* Header */}
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">View your children's information</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 text-lg">No children information available</p>
        </div>
      )}
    </div>
  );
