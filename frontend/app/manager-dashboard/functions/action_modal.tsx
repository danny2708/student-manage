...
export function ActionModal({ onClose, onShowInfo, onModify, onDelete }: ActionModalProps) {
  return (
    <div className="bg-white rounded-lg shadow-xl w-48 p-4">
      {/* Close button */}
      <button onClick={onClose} className="absolute top-2 right-2 text-red-500 hover:text-red-700 transition-colors" aria-label="Close modal">
        <X className="h-4 w-4" />
      </button>
