...
export function UserAccountModal({ user, onClose }: UserAccountModalProps) {
  ...
  const [userData, setUserData] = useState({
    ...
    gender: user.gender,
    dob: user.dob,
    password: user.password || "ibelieveicanfly",
  });
    ...
    <div className="relative bg-white rounded-lg shadow-xl w-full h-full flex flex-col overflow-hidden">
      ...
      <div className="flex flex-1">
        ...
        <div className="relative bg-gradient-to-br from-red-400 to-red-500 text-white p-6 flex flex-col items-center justify-center w-60">
          ...
          <p className="text-sm opacity-90 mb-3">{user.role}</p>
          <button
          ...
          <div className="grid grid-cols-2 gap-y-8 gap-x-12 text-base">
            ...
            <div className="flex items-center gap-2 text-pink-500">
              ...
              <div className="flex-1 flex items-center gap-2">
                ...
                <button
                  ...
                  className={`${isEditing ? 'text-gray-400' : 'text-pink-500'}`}
            ...
            <div className="flex items-center gap-2 text-blue-500">
              ...
              <div className="flex-1 flex items-center gap-2">
                ...
                <button
                  onClick={() => setIsEditing(true)}
                  className={`${isEditing ? 'text-gray-400' : 'text-blue-500'}`}
            ...
            <div className="flex items-center gap-2 text-purple-500">
              ...
              <div className="flex-1 flex items-center gap-2">
                ...
                <button
                  onClick={() => setIsEditing(true)}
                  className={`${isEditing ? 'text-gray-400' : 'text-purple-500'}`}
            ...
            <div className="flex items-center gap-2 text-green-500">
              ...
              <div className="flex-1 flex items-center gap-2">
                ...
                <button
                  onClick={() => setIsEditing(true)}
                  className={`${isEditing ? 'text-gray-400' : 'text-green-500'}`}
            ...
            <div className="flex items-center gap-2 text-blue-400">
              ...
              <div className="flex-1 flex items-center gap-2">
                ...
                <button
                  onClick={() => setIsEditing(true)}
                  className={`${isEditing ? 'text-gray-400' : 'text-blue-400'}`}
            ...
            <div className="flex items-center gap-2 text-gray-600 col-span-2">
              ...
              <div className="flex-1 flex items-center gap-2">
                ...
                <button
                  onClick={() => setIsEditing(true)}
                  className={`${isEditing ? 'text-gray-400' : 'text-gray-600'}`}
