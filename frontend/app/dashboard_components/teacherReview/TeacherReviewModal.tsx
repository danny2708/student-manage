        ...
        <div className="max-w-[1200px] mx-auto p-6">
          ...
          {view === "list" && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {loadingTeachers ? (
                <div className="col-span-full text-center p-8 text-gray-600">Loading teachers...</div>
              ) : teachers.length === 0 ? (
                <div className="col-span-full text-center p-8 text-gray-600">No teachers found.</div>
              ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative overflow-hidden h-28">
                        ...
                        {/* top rated badge */}
                        {isTop && (
                          <div className="absolute top-3 right-3 bg-white/95 text-black rounded-full px-3 py-1 text-sm font-medium shadow flex items-center gap-2">
                      ...
                      <CardContent className="p-6 -mt-12 relative text-center">
                        ...
                        <h3 className="text-lg font-bold text-gray-900 mb-1">{teacher.full_name ?? `#${teacher.teacher_user_id}`}</h3>
                        ...
                        <div className="space-y-2 text-sm text-gray-600">
                          <div className="flex items-center justify-center gap-2">
                            <div className="inline-flex items-center gap-2 bg-white/60 px-2 py-1 rounded-full">
            ...
            <div className="max-w-3xl mx-auto">
              <Card className="border-0 shadow-lg">
                <CardContent className="p-8">
                  ...
                  <div className="flex items-center gap-4 mb-6 bg-gradient-to-r from-sky-50 to-cyan-50 rounded-lg p-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <div>
                          <h3 className="text-xl font-bold text-gray-900">{selectedTeacher.full_name ?? `#${selectedTeacher.teacher_user_id}`}</h3>
                        ...
                        <div className="text-right flex flex-col items-end gap-2">
                          <div className="inline-flex items-center gap-2 bg-white rounded-md px-3 py-1 shadow-sm">
                            <Star className="w-4 h-4 text-yellow-400" />
                            <span className="font-semibold text-gray-900">{teacherStats.get(selectedTeacher.teacher_user_id)?.avg ?? "—"}</span>
                            <span className="text-xs text-gray-500">({teacherStats.get(selectedTeacher.teacher_user_id)?.count ?? 0})</span>
                          </div>
                  ...
                  <div className="mb-6">
                    <label className="block text-lg font-semibold text-gray-900 mb-4">Rate your experience</label>
                        ...
                        >
                          <Star
                            className={`w-12 h-12 transition-colors ${
                              star <= (hoveredRating || rating) ? "fill-yellow-400 text-yellow-400" : "text-gray-300 hover:text-yellow-200"
                            }`}
                          />
                        </button>
                      ))}
                    </div>
                    {rating > 0 && <p className="text-center mt-3 text-gray-600">You rated: <span className="font-semibold text-blue-600">{rating} stars</span></p>}
                  </div>

                  <div className="mb-6">
                    <label className="block text-lg font-semibold text-gray-900 mb-4">Share your thoughts</label>
                    <Textarea
                      value={reviewContent}
                    ...
                    />
                    <p className="text-sm text-gray-500 mt-2">{reviewContent.length} characters</p>
                  </div>
          ...
          {view === "history" && (
            <div className="max-w-4xl mx-auto space-y-6">
              {reviewsLoading || loadingTeachers ? (
                <div className="text-center p-8 text-gray-600">Loading reviews...</div>
              ) : myReviews.length === 0 ? (
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-12 text-center">
                    <div className="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                      <StarOff className="w-10 h-10 text-gray-400" />
                    </div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">No reviews yet</h3>
                    <p className="text-gray-600 mb-6">Start sharing your experience with your teachers!</p>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            <h3 className="text-lg font-bold text-gray-900">{r.teacher_name ?? r.teacher_full_name ?? `#${r.teacher_user_id}`}</h3>
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-sm text-gray-500">{formatDate(r.created_at ?? r.review_date)}</p>
                        </div>
                      </div>

                      <div className="bg-gray-50 rounded-lg p-4">
                        <p className="text-gray-700 leading-relaxed">{getReviewText(r)}</p>
                      </div>
                      ...
                      <div className="flex items-center space-x-3 mt-4 pt-4 border-t border-gray-200 justify-end">
                        ...
                        <button className="flex items-center space-x-2 text-gray-600 hover:text-sky-500 transition-colors">
