      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white p-6 rounded-2xl w-full max-w-3xl shadow-2xl border border-gray-200 max-h-[90vh] overflow-y-auto"
          >
            ...
            {/* Form */}
            <form onSubmit={(e) => handleSubmit(e)} className="space-y-5 text-gray-800">
          ...
          <AnimatePresence>
            {showEditQuickModal && editingQuick && (
              ...
              >
                <motion.div
                  className="bg-white rounded-xl shadow-xl p-4 w-full max-w-lg"
                  onClick={(e) => e.stopPropagation()}
