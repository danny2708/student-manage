...
export default function TestManagement() {
  ...
  return (
    <div className="relative p-6 bg-white rounded-lg shadow-md min-h-[85vh]">
      {/* Header */}
            ...
            <AnimatePresence>
              {showFilter && (
                <motion.div
                  ...
                  className="absolute right-0 mt-2 w-[360px] z-40 bg-white border border-gray-200 rounded-lg shadow-lg p-4"
                >
                  <div className="space-y-3 text-black">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className="w-full border px-2 py-1 rounded-md text-black"
                      />
                    </div>
                    ...
                    <button
                      ...
                      className="px-4 py-1.5 rounded-md border text-sm text-gray-700 hover:bg-gray-100 cursor-pointer"
                    >
                      Clear
                    </button>
                      <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredTests.map((t, index) => (
            <motion.div
              key={t.test_id}
              whileHover={{ y: -5 }}
              className="group relative flex flex-col gap-4 border border-black bg-white p-6 rounded-2xl transition-all duration-200 cursor-pointer animate-fadeIn hover:shadow-lg"
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-black line-clamp-2 transition-transform duration-200 origin-left group-hover:scale-105">
                {t.test_name}
              </h3>

              <div className="space-y-3 relative z-10">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-black font-medium">Student</span>
                  <span className="text-sm text-black font-medium group-hover:scale-105">
                    {t.student_name ?? t.student_user_id}
                  </span>
                </div>

                <div className="flex justify-between items-center">
                  <span className="text-sm text-black font-medium">Score</span>
                  <span
              ...
              {(user?.roles?.includes("teacher") || user?.roles?.includes("manager")) && (
                <div className="flex gap-2 pt-2">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 border border-black rounded-md px-2 py-1 text-sm hover:bg-yellow-400 transition-all duration-150 hover:scale-105 active:scale-95 cursor-pointer"
                  >
                    Edit
                  </button>
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 border border-black rounded-md px-2 py-1 text-sm hover:bg-red-400 hover:text-red-600 transition-all duration-150 hover:scale-105 active:scale-95 cursor-pointer"
                  >
                    Delete
                  </button>
                </div>
