...
export function TestDetailPanel({
  ...
  return (
    <>
      ...
      <div
        className={`fixed right-0 top-0 h-full w-full max-w-md bg-white border-l border-gray-200 shadow-2xl transition-transform duration-300 z-50 ${
          isOpen
      ...
      >
        ...
        <div className="overflow-y-auto p-6 space-y-2 text-sm">
          {[
            {
              icon: <ClipboardList className="text-black" size={18} />,
              label: "Test ID",
              value: test.test_id,
            },
            {
          ...
          <div className="flex items-center justify-between py-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-black font-medium">Exam Date</span>
            </div>
